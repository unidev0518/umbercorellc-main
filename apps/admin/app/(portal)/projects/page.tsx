                ...
                <tr key={p.id} className="tr">
                  ...
                  <td className="td text-right">
                    <Link href={`/projects/${p.id}`}
                      ...
                      onMouseEnter={(e: MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.borderColor = "var(--border-default)")}
                      onMouseLeave={(e: MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.borderColor = "var(--border-subtle)")}>
