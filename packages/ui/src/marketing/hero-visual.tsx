...
import { CheckCircle2, Cloud, Database, Sparkles } from "lucide-react";
...
const profiles = [
  { initials: "SW", bg: "from-brand-green/30 to-brand-blue/20" },
  { initials: "DT", bg: "from-brand-blue/30 to-violet-500/20" },
  { initials: "CL", bg: "from-violet-500/30 to-brand-green/20" },
];
    ...
    <div className="relative mx-auto w-full max-w-[520px]">
        ...
        <FloatCard delay={0.6} className="absolute bottom-5 left-5 right-5">
          <div className="flex items-center gap-3 rounded-xl border border-white/[0.1] bg-surface-dark/80 p-3.5 backdrop-blur-md">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[11px] font-semibold text-foreground/90">Delivery team aligned</p>
              <p className="text-[10px] text-foreground/45">Software · Data · Cloud</p>
            </div>
        ...
        <div className="rounded-xl border border-white/[0.1] bg-surface-elevated/90 p-4 shadow-elevated backdrop-blur-md">
          <div className="flex items-center gap-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-green/15">
              <Sparkles className="h-4 w-4 text-brand-green" strokeWidth={1.8} />
            </span>
            <div>
              <p className="text-sm font-semibold text-foreground/90">AI-assisted</p>
              <p className="mt-0.5 text-[10px] text-foreground/45">Development workflows</p>
            </div>
          </div>
        </div>
      </FloatCard>
        ...
        <div className="rounded-xl border border-white/[0.1] bg-surface-elevated/90 p-4 shadow-elevated backdrop-blur-md">
          <div className="flex items-center gap-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-blue/15">
              <Database className="h-4 w-4 text-brand-blue" strokeWidth={1.8} />
            </span>
            <div>
              <p className="text-sm font-semibold text-foreground/90">Data processing</p>
              <p className="mt-0.5 text-[10px] text-foreground/45">Pipelines &amp; integration</p>
            </div>
          </div>
        </div>
      </FloatCard>
      ...
      <FloatCard delay={0.65} className="absolute -right-4 bottom-24 sm:-right-6">
        <div className="rounded-xl border border-white/[0.1] bg-surface-elevated/90 p-4 shadow-elevated backdrop-blur-md">
          <div className="flex items-center gap-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-green/15">
              <Cloud className="h-4 w-4 text-brand-green" strokeWidth={1.8} />
            </span>
            <div>
              <p className="text-sm font-semibold text-foreground/90">Cloud hosting</p>
              <p className="mt-0.5 text-[10px] text-foreground/45">Apps, APIs &amp; workloads</p>
            </div>
          </div>
        </div>
      </FloatCard>
      ...
      <FloatCard delay={0.3} className="absolute left-4 top-4">
        <div className="flex items-center gap-2 rounded-full border border-brand-green/20 bg-surface-dark/80 px-3 py-1.5 backdrop-blur-sm">
          ...
          <span className="text-[11px] font-semibold text-foreground/70">Technology consulting</span>
        </div>
      </FloatCard>
    </div>
  );
